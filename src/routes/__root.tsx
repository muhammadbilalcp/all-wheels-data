...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The Motor Compendium — An illustrated catalog of the automobile" },
      { property: "og:description", content: "An editorial encyclopedia of cars: specifications, history, and notable details from vintage classics to modern hypercars." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "The Motor Compendium — An illustrated catalog of the automobile" },
      { name: "twitter:description", content: "An editorial encyclopedia of cars: specifications, history, and notable details from vintage classics to modern hypercars." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c0af6b2-9ecf-4264-a95d-900565bdbd0d/id-preview-85e899d9--024263e8-8714-4603-8fd4-55e1a8e2893a.lovable.app-1779610340253.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c0af6b2-9ecf-4264-a95d-900565bdbd0d/id-preview-85e899d9--024263e8-8714-4603-8fd4-55e1a8e2893a.lovable.app-1779610340253.png" },
    ],
